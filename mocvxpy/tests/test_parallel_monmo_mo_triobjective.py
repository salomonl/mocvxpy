...
def test_solve_qp_st_linear_constraints_with_MONMO():
    # Parameters
...
def test_solve_ellipsoidal_pb_with_MONMO():
    # Parameters
    a = 7.0
    x = mocp.Variable(3)
...
def test_solve_power_of_4_pb_st_qp_constraints_with_MONMO():
    x = mocp.Variable(2)
    objectives = [
...
def test_solve_qcqp_with_MONMO():
    x = mocp.Variable(3)
